...
These are the exercise labs for the third module of the CodingNomads Python Programming course.

This folder contains **my copy** of all the labs that I've completed.
